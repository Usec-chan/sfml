...
int main()
{
	...
	Texture tileSet;
	tileSet.loadFromFile("C:\\Users\\kalex\\source\\repos\\Project2\\texture\\Mario_tileset.png");

	Font font;
	font.loadFromFile("C:\\Users\\kalex\\Desktop\\sansation.ttf");
	Text mytext("Hello!", font, 50);
	Text point("points: ", font, 50);
	point.setPosition(10, 10);
	mytext.setPosition(220, 10);
	int q = 0;
	q = points;
	...
	SoundBuffer buffer;
	buffer.loadFromFile("C:\\Users\\kalex\\source\\repos\\Project2\\music\\Jump.ogg");
	Sound sound(buffer);

	Music music;
	music.openFromFile("C:\\Users\\kalex\\source\\repos\\Project2\\music\\Mario_Theme.ogg");
	music.play();
